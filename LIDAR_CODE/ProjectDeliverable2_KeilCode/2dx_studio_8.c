...
void PortJ_Init(void){
  ...
  GPIO_PORTJ_DEN_R |= 0x03;     									// Enable digital I/O on PJ1 PJ0
	
	GPIO_PORTJ_PCTL_R &= ~0x000000FF;	 						// Configure PJ1 PJ0 as GPIO 
...
/* Those basic I2C read functions can be used to check your own I2C functions */
	...
	status = VL53L1X_ClearInterrupt(dev); /* clear interrupt has to be called to enable next interrupt(interrupt from the sensor)*/
...
//	
 ...
 /* 8 clear interrupt has to be called to enable next interrupt*/
